Overview:
=========
  The purpose of the httpgateway quickstart sample is to prove that the SOA-P 5 
  can send HTTP requests to FSW6.
...
===========================
  ...
  http://localhost:8280/soa5_httprouter-0.0.1-SNAPSHOT/http/example/a/b/c

  5. Follow the directions in fsw6_httprouter, and start your EAP server 

  6. Browse to the http gateway in SOA 5 (endpoint above), and watch
  the request in both the SOA-P 5 and FSW6 server consoles. 
